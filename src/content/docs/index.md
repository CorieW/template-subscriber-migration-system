...
17. The tool builds an AI prompt from the bundle, repo context, drift, and maintainer instructions.
18. The configured provider returns JSON file operations: `create`, `update`, or `delete`.
